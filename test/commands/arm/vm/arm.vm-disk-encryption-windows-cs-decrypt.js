...
var testLocation,
  testprefix = 'arm-cli-vm-disk-encryption-windows-cs-decrypt',
...
describe('arm', function () {
  describe('compute', function () {
    ...
    describe('vm', function () {
      it('should VmQuickCreateWindows-EncryptUsingClientSecret-GetStatusEncrypted-Decrypt', function (done) {
