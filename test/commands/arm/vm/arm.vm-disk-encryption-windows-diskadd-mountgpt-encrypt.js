...
var testLocation,
  testprefix = 'arm-cli-vm-disk-encryption-windows-diskadd-mountgpt-encrypt',
...
describe('arm', function () {
  describe('compute', function () {
    ...
    describe('vm', function () {
      it('should VmQuickCreateWindows-DiskAdd-MountGpt-EncryptUsingClientSecret-GetStatusEncrypted', function (done) {
        ...
        testUtils.executeCommand(suite, retry, cmd, function(result) {
            ...
            testUtils.executeCommand(suite, retry, cmd, function(result) {
                ...
                var csePublicConfig = '{"fileUris":["https://adetestsa.blob.core.windows.net/scripts/FormatGPTDisk.ps1"],"commandToExecute":".\\FormatGPTDisk.ps1"}';
