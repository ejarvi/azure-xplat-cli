...
var testLocation,
  testprefix = 'arm-cli-vm-disk-encryption-windows-cc-kek-template',
...
describe('arm', function () {
  describe('compute', function () {
    ...
    describe('vm', function () {
      it('should VmQuickCreateWindows-EncryptUsingClientCertificateTemplate-GetStatusEncrypted', function (done) {
        ...
        testUtils.executeCommand(suite, retry, cmd, function(result) {
            ...
            testUtils.executeCommand(suite, retry, cmd, function(result) {
                ...
                var encryptUri = 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-encrypt-running-windows-vm-aad-client-cert/azuredeploy.json';
                var encryptParams = util.format('{"vmName"="%s","aadClientID"="%s","aadClientCertThumbprint"="%s","keyVaultName"="%s","keyVaultResourceGroup","%s"}',vmName,aadClientID,aadClientCertThumbprint,keyVaultName,keyVaultResourceGroup);
