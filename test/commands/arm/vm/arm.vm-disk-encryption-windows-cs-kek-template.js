...
var testLocation,
  testprefix = 'arm-cli-vm-disk-encryption-windows-cs-kek-template',
    ...
    describe('vm', function () {
      it('should VmQuickCreateWindows-EncryptUsingClientSecretTemplate-GetStatusEncrypted', function (done) {
        ...
        testUtils.executeCommand(suite, retry, cmd, function(result) {
            ...
            // encrypt with arm template using client secret + kek  
            ...
            var encryptParams = util.format('{"vmName"="%s","aadClientID"="%s","aadClientSecret"="%s","keyVaultName"="%s","keyVaultResourceGroup"="%s","useExistingKek"="kek",keyEncryptionKeyURL"="%s"}',vmName,aadClientID,aadClientSecret,keyVaultName,keyVaultResourceGroup,keyEncryptionKeyUrl);
